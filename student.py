...
class Student:
    def __init__(self,root):
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("Dep",
        "Course",
        "Year",
        "Sem",
        "ID",
        ...
        self.student_table.heading("Mob-No", text="Phone")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="":
            ...
            try:
                ...
                print("Error",self.var_std_id.get())
